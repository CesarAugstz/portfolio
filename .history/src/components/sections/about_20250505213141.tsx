        ...
        >
          ...
          <div className="space-y-6">
            ...
            <motion.p variants={itemVariants} className="text-muted-foreground">
              Hello! I'm a passionate frontend developer with over 5 years of experience creating modern web
              applications. I specialize in React, Next.js, and TypeScript, with a strong focus on creating accessible,
            ...
            <motion.p variants={itemVariants} className="text-muted-foreground">
              ...
              startups and established companies to bring their digital products to life. I'm passionate about clean
              code, user experience, and staying up-to-date with the latest web technologies.
            </motion.p>
